...
export HISTFILE="$XDG_DATA_HOME/bash/history" #something is overriding bash_history with history, forcing history then
export HISTCONTROL="$HISTCONTROL erasedups:ignoreboth"

#export PS1="\[\033[01;31m\]\h\[\033[01;34m\] \$(pwd) \$\[\033[00m\] "

#PS1 created using https://bashrcgenerator.com/, output: [18:33:25] kenose ~ $
time_color="38;5;2m"
address_color="38;5;14m"
path_color="38;5;6m"
...
export PATH="$PATH:$HOME/bin:/usr/games/bin:$HOME/install/android-sdk-linux/platform-tools/:$HOME/install/android-sdk-linux/tools:$HOME/.local/bin:$HOME/install/Linux_Unreal_Engine_5.2.1/Engine/Binaries/Linux/:$HOME/.local/share/solana/install/active_release/bin:$HOME/install/certbot-namecheap-hook:$HOME/install/VSCode-linux-x64/bin/"
...
# moved to $XDG_CONFIG_HOME/bash/bash_functions, don't define functions here
# genpasswd() {
#	local l=$1
#       	[ "$l" == "" ] && l=20
...
export PATH="$PATH:/home/talto/.lmstudio/bin"
